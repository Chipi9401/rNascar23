...
namespace rNascar26.Launcher
{
    internal class AppContext : ApplicationContext
    {
        ...
        public AppContext()
        {
            ...
            {
                var patcherExePath = Path.Combine(installFolder, $"{LauncherDirectory}\\rNascar26.Patcher.exe");
            ...
            var exePath = Path.Combine(installFolder, "rNascar26.exe");

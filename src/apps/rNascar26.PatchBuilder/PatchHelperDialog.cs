using rNascar26.PatchBuilder.Properties;
using rNascar26.Patches.AppRegistry;
using rNascar26.Patches.GitHub;
using rNascar26.Patches.Models;
using rNascar26.Patches.Services;
using System;
...
namespace rNascar26.PatchBuilder
{
    public partial class PatchHelperDialog : Form
    {
        ...
        private void btnBuildRelease_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    buildDirectory = "C:\\Users\\Rob\\Source\\repos\\rNascar26\\src\\apps\\rNascar26\\bin\\Release";
                }
                else
                {
                    buildDirectory = "C:\\Users\\Rob\\Source\\repos\\rNascar26\\src\\apps\\rNascar26\\bin\\Debug";
                }
                ...
                if (chkIncludeLauncher.Checked)
                {
                    ///*** rNascar26.Launcher - Can't patch launcher ***/
                    buildDirectory = "C:\\Users\\Rob\\Source\\repos\\rNascar26\\src\\apps\\rNascar26.Launcher\\bin\\Debug";
                    ...
                    /*** rNascar26.Patcher ***/
                    buildDirectory = "C:\\Users\\Rob\\Source\\repos\\rNascar26\\src\\apps\\rNascar26.Patcher\\bin\\Debug";
                ...
                /*** zip file ***/
                var zipFileDirectory = "C:\\Users\\Rob\\source\\repos\\rNascar26\\patches";
        ...
        {
            var assemblyFilePath = "C:\\Users\\Rob\\source\\repos\\rNascar26\\src\\GlobalAssemblyInfo.cs";
        ...
        private bool UpdateGlobalAssemblyInfo(string versionNumber)
        {
            try
            {
                var globalAssemblyInfoFilePath = "C:\\Users\\Rob\\Source\\repos\\rNascar26\\src\\GlobalAssemblyInfo.cs";
        ...
        private void btnOpenPatchZip_Click(object sender, EventArgs e)
        {
            ...
            dialog.InitialDirectory = "C:\\Users\\Rob\\source\\repos\\rNascar26\\patches";

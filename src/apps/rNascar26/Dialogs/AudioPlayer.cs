...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        private async Task InitializeBrowserAsync(string url = null)
        {
            try
            {
                var userDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\rNascar26";
        ...
        private void DisplayAudioChannelList(IList<AudioChannel> channels)
        {
            ...
            cboChannels.DisplayMember = "DriverName";
            cboChannels.ValueMember = "StreamNumber";

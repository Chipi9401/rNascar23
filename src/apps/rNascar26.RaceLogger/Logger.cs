...
namespace rNascar26.RaceLogger
{
    public partial class Logger : Form
    {
        ...
        private const string EventsDirectory = "C:\\Users\\Rob\\Documents\\rNascar26\\Events";
        private const int MaxNumberOfLines = 50;
        private const string LogFileName = "rNascar26.Logger.Log.{0}.txt";
